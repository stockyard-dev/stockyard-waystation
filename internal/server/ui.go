...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> WAYSTATION</h1>
...
var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "name", "label": "Name", "type": "text"}, {"name": "destination", "label": "Destination", "type": "text"}, {"name": "start_date", "label": "Start Date", "type": "date"}, {"name": "end_date", "label": "End Date", "type": "date"}, {"name": "budget", "label": "Budget", "type": "integer"}, {"name": "itinerary", "label": "Itinerary", "type": "text"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "notes", "label": "Notes", "type": "textarea"}, {"name": "created_at", "label": "Created At", "type": "text"}];
